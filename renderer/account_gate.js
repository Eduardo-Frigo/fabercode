(function () {
  ...
  function createAccountGateController(options = {}) {
    ...
    const elements = {
      ...
      workspaceSelect: doc.getElementById('account-gate-workspace'),
      signupWorkspaceSelect: doc.getElementById('account-gate-signup-workspace'),
    ...
    function getWorkspacePreference() {
      ...
      const rawValue = authView === 'email' && authMode === 'signup' && elements.signupWorkspaceSelect
    ...
    function showEmailForm(nextMode = 'login') {
      ...
      if (elements.signupWorkspaceSelect && elements.workspaceSelect) {
        elements.signupWorkspaceSelect.value = normalizeWorkspacePreference(elements.workspaceSelect.value);
      }
    ...
    function bindEvents() {
      ...
      if (elements.signupWorkspaceSelect) {
        elements.signupWorkspaceSelect.addEventListener('change', () => {
          applyWorkspacePreference();
        });
      }
      if (elements.back) {
