(function () {
  ...
  function buildAiSettingsApiRows({ draft, translate }) {
    ...
    rows.push({
      ...
      providerName: 'pexels',
      title: 'Pexels',
      subtitle: draft.pexels.hasKey ? t('pexelsOwnKeyActiveSubtitle') : t('pexelsOwnKeySubtitle'),
      selectable: false,
      editable: true,
      hasKey: Boolean(draft.pexels.hasKey),
      keyLabel: draft.pexels.hasKey ? '' : t('pexelsOwnKeyRequired'),
    ...
    draft.customApis.forEach((item) => {
      ...
      rows.push({
        ...
        providerName,
        title: humanizeProviderName(providerName || t('customService')),
