...
function run() {
  ...
  try {
    ...
    assert.strictEqual(saved.welcomeQuoteLastAuthor, 'Sócrates');
    ...
    assert.strictEqual(stored.welcomeQuoteLastAuthor, 'Sócrates');
    ...
    assert.strictEqual(disabledDefaultOpenAi.selectedProvider, 'mock');
