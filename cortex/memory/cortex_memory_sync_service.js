function createCortexMemorySyncService(dependencies = {}) {
  ...
  function buildCortexMemoryEntry(input = {}) {
    ...
    return {
      id: input.memoryId || `cortex-memory-${Date.now()}-${Math.random().toString(36).slice(2, 8)}`,
      type: 'cortex_memory',
      topic,
      ...
      lifecycleAction: input.lifecycleAction || null,
      expiresAt: input.expiresAt || null,
      validity: input.validity && typeof input.validity === 'object' ? input.validity : null,
    };
  }
